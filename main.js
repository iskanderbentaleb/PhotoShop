...
/*function call when slider value change*/
  ...
  function editImage(){
	...
	image.style.filter = 'grayscale('+ greyVal +'%) contrast('+ contrastVal +'%)  hue-rotate('+ hueVal +'deg) brightness('+ brightVal +'%) blur('+ blurVal +'px) saturate('+ satuVal +')';
	context.filter = 'grayscale('+ greyVal +'%) contrast('+ contrastVal +'%)  hue-rotate('+ hueVal +'deg) brightness('+ brightVal +'%) blur('+ blurVal +'px) saturate('+ satuVal +')';
